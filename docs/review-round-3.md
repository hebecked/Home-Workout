...
Apply the six repeated illustration corrections, keep names and targets readable on phones, add a responsibility notice and public GitHub feedback link, and publish the tested result.
...
- Exercise names appear above the image; targets below. Exit is in the header with confirmation. Narrow-screen tests check both axes and navigation scroll reset.
- The Impressum links the public GitHub feedback forum and warns against posting health or confidential information. The responsibility notice does not exclude statutory liability.
