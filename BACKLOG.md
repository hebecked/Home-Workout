...
- [ ] Consider an optional AI-generation metadata field for workout plans. Keep existing JSON plans and shared links compatible; do not add comments inside JSON.
